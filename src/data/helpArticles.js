...
export const HELP_ARTICLES = [
  ...
  { id: 'fees', audience: 'provider', q: 'Kolika je naknada i kako rade nivoi?', keywords: ['naknad', 'provizij', 'procen', 'nivo', 'bronz', 'srebr', 'zlat', 'platin', 'tier'],
    a: 'Naknada se plaća samo na uspješno završene poslove i zavisi od tvog nivoa u zadnjih 30 dana: Bronza 15 %, Srebro (500 KM+) 13 %, Zlato (1.500 KM+) 11 %, Platina (3.000 KM+) 9 %. Nivo se računa automatski — vidiš ga u „Moj nalog → Ploča izvođača“.' },
